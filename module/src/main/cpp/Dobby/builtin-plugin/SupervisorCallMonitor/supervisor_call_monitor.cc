...
static const char *fast_get_main_app_bundle_udid() {
    ...
    char *bundle_udid_ndx =
            main_binary_path + strlen("/private/var/containers/Bundle/Application/");
...
static void
common_supervisor_call_monitor_handler(DobbyRegisterContext *ctx, const InterceptEntry *info) {
...
void supervisor_call_monitor_register_system_kernel() {
    ...
    auto text_section = macho_kit_get_section_by_name((mach_header_t *) libsystem_header, "__TEXT",
                                                      "__text");
    ...
    addr_t __psynch_mutexwait_svc_addr = (addr_t) DobbySymbolResolver("libsystem_kernel.dylib",
                                                                      "__psynch_mutexwait");
