        ...
        public:
            ...
            void link_confused_instructions(CodeBuffer *buffer) {
                ...
                for (auto &ref_label_inst: ref_label_insts_) {
                    ...
                    thumb1_inst_t insn2 = _buffer->LoadThumb1Inst(
                            ref_label_inst.offset_ + sizeof(thumb1_inst_t));
                    ...
                    switch (ref_label_inst.type_) {
                        ...
                        case kThumb2LiteralLdr: {
                            ...
                            _buffer->RewriteThumb1Inst(ref_label_inst.offset_ + Thumb1_INST_LEN,
                                                       insn2);

                            DLOG(0, "[thumb label link] insn offset %d link offset %d",
                                 ref_label_inst.offset_, imm12);
                        }
                            break;
                        default:
                            UNREACHABLE();
        ...
        private:
            ...
            void EmitThumb2Branch(Condition cond, int32_t imm, bool link) {
                ...
                if (link) {
                    ...
                    EmitInt16(0x9000 | LeftShift(j1, 1, 13) | (LeftShift(j2, 1, 11)) |
                              LeftShift(imm11, 11, 0) | B14);
                } else {
                    EmitInt16(0x9000 | LeftShift(j1, 1, 13) | (LeftShift(j2, 1, 11)) |
                              LeftShift(imm11, 11, 0));
                }
            }
        };
...
// ---
        ...
        public:
            ...
            ThumbTurboAssembler(void *address, CodeBuffer *buffer) : ThumbAssembler(address,
                                                                                    buffer) {
            }
...
// ===
            ...
            void AlignThumbNop() {
                addr32_t pc =
                        this->GetCodeBuffer()->GetBufferSize() + (uintptr_t) GetRealizedAddress();
            ...
            void RelocBind() {
                for (auto *data_label: data_labels_) {
                    ...
                    reinterpret_cast<CodeBufferBase *>(buffer_)->EmitBuffer(data_label->data_,
                                                                            data_label->data_size_);
                }
            }
