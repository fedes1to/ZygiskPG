...
void Modifications(){
    ...
    DobbyHook((void*)(g_il2cppBaseMap.startAddress + 0x48F182C), (void*)canBuy, (void**)&old_canBuy);
    DobbyHook((void*)(g_il2cppBaseMap.startAddress + 0x48F0500), (void*)isEvent, (void**)&old_isEvent);
}
