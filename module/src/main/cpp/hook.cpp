...
const char* curList[] = { OBFUSCATE("GemsCurrency"), OBFUSCATE("Coins"), OBFUSCATE("ClanSilver"), OBFUSCATE("ClanLootBoxPoints"),  OBFUSCATE("Coupons"), OBFUSCATE("PixelPassCurrency"), OBFUSCATE("RouletteAdsCurrency"), OBFUSCATE("PixelBucks"), OBFUSCATE("RouletteAdsSpin") };
        ...
        if (isValidAuth) {
            ...
            if (ImGui::BeginTabBar("Menu", tab_bar_flags)) {
                ...
                if (ImGui::BeginTabItem(OBFUSCATE("Player"))) {
                    ImGui::Checkbox(OBFUSCATE("Spoof ID"), &spoofID);
